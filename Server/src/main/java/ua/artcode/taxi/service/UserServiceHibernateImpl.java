...
public class UserServiceHibernateImpl implements UserServiceHibernate {
    ...
    private final static Logger LOG = Logger.getLogger(UserServiceHibernateImpl.class);

    private UserDaoHibernate userDaoHibernate;
    private OrderDao orderDao;
    private ValidatorHibernate validatorHibernate;
    private double pricePerKilometer;
    private GoogleMapsAPI googleMapsAPI;
    private Map<String, User> accessKeys;

    public UserServiceHibernateImpl(UserDaoHibernate userDaoHibernate,  ValidatorHibernate validatorHibernate) {
        this.userDaoHibernate = userDaoHibernate;

        this.validatorHibernate = validatorHibernate;
    ...
    public User updateUser(Map<String, String> map, String accessToken, EntityManagerFactory entityManagerFactory) throws RegisterException {
        ...
        if (!validatorHibernate.validateChangeRegistration(typeUser, idUser, map.get("phone"),entityManagerFactory)) {
            ...
            User updatedUser = userDaoHibernate.updateUser(newUser);
    ...
    public User deleteUser(String accessToken) {
        ...
        User deleteUser = userDaoHibernate.deleteUser(user.getId());
